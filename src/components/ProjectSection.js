    ...
    return (
        <section className="my-4">
            <div className="container my-4">
                <div id="projects" class="m-4 p-4 text-white rounded-3 bgcolor boxshadow">
                    <h2>My projects</h2>
                    <p>
                        I pride myself on my ability to take an idea from an inspired thought, to the whiteboard, and finally from my screen and on to yours!
